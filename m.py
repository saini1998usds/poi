...
bot = telebot.TeleBot('7285066664:AAFy3XQ2YBTgdG44epzQc455zWXbRJ8gLv4')
...
def log_command(user_id, target, port, time):
    admin_id = ["5289532351","1020212046"]
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "contact admin for authorized access:- @devilgamersyt 🔐."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 𝐔𝐍𝐀𝐔𝐓𝐇𝐎𝐑𝐈𝐙𝐄𝐃 𝐀𝐂𝐂𝐄𝐒𝐒 𝐍𝐈𝐊𝐀𝐋 𝐋𝐀𝐕𝐃𝐄 𝐁𝐔𝐘 𝐊𝐄𝐘🚫\n\nOops! It seems like you don't have permission to use the /bgmi command.                                                                          DM TO BUY ACCESS:- @devilgamersyt")
...
def show_command_logs(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "𝐘𝐨𝐮 𝐀𝐫𝐞 𝐍𝐨𝐭 𝐀𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐓𝐨 𝐔𝐬𝐞 𝐓𝐡𝐢𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 😡."
...
Buy From :- @devilgamersyt
Official Channel :- https://t.me/BsilentPro
'''
...
3. Make Sure To Join The Channel https://t.me/BsilentPro OtherWise WontWork
